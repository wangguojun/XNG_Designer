            ...
            if (pal != null) {
                var res =
                    "group { \
						...
						Panel1: Panel { text: '选择要测试的合成(默认速度为2倍)', orientation: 'row', minimumSize:" + check.panelSize + ", margins: 15, spacing: 5, \
                        Gr1a: Group {\
                            alignment: ['right','center'], spacing:5,\
                            input01: EditText { text:'" + num.skipFrames + "', preferredSize:[22,20], alignment:['right','center'] }, \
                        }\
                        Gr1b: Group {\
								alignment:['right','top'], \
                        ...
                        Gr1: Group {\
                            alignment:['right','top'], \
							help: Button { text:'帮助', preferredSize:[50,25], alignment:['left','center'] }, \
							mainButton: Button { text:'删除所有测试文件', preferredSize:[140,30], alignment:['right','center'] }, \
                        }\
                    }\
					}";
                ...
                pal.grp.Panel1.Gr1a.input01.onChange = function () {
                    if (isNaN(this.text)) this.text = num.skipFrames;
                    num.skipFrames = parseFloat(this.text);
                }
                ...
                pal.grp.Panel1.Gr1b.mainButton.onClick = function () {
                    {
                        var renderTimeArray = [];
                        ...
                        function renderModule() {
                            ...
                            for (var i = 1; i <= renderNum; i++) {
                                ...
                                //将渲染队列中的第i个跳2帧渲染
                                app.project.renderQueue.item(i).skipFrames = num.skipFrames;
                            }
